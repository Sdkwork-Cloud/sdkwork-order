...
/** After Sales events list. */
  async list(afterSalesRequestId: string, params?: OrderAfterSalesAfterSalesEventsListParams, requestOptions?: ApiRequestOptions): Promise<SdkWorkPageData> {
...
/** After Sales return Shipments list. */
  async list(afterSalesRequestId: string, params?: OrderAfterSalesAfterSalesReturnShipmentsListParams, requestOptions?: ApiRequestOptions): Promise<SdkWorkPageData> {
    const query = buildQueryString([
...
/** After Sales return Shipments create. */
  async create(afterSalesRequestId: string, body: CreateAfterSalesReturnShipmentRequest, params: OrderAfterSalesAfterSalesReturnShipmentsCreateParams, requestOptions?: ApiRequestOptions): Promise<AfterSalesReturnShipmentResponse> {
...
/** After Sales requests list. */
  async list(params?: OrderAfterSalesAfterSalesRequestsListParams, requestOptions?: ApiRequestOptions): Promise<SdkWorkPageData> {
    const query = buildQueryString([
      { name: 'status', value: params?.status, style: 'form', explode: true, allowReserved: false },
...
/** After Sales requests create. */
  async create(body: CreateAfterSalesRequest, params: OrderAfterSalesAfterSalesRequestsCreateParams, requestOptions?: ApiRequestOptions): Promise<AfterSalesRequestResponse> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
...
/** After Sales requests update. */
  async update(afterSalesRequestId: string, body: UpdateAfterSalesRequest, params: OrderAfterSalesAfterSalesRequestsUpdateParams, requestOptions?: ApiRequestOptions): Promise<AfterSalesRequestResponse> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
...
export class OrderAfterSalesAfterSalesApi {
  private client: HttpClient;
  public readonly requests: OrderAfterSalesAfterSalesRequestsApi;
  public readonly returnShipments: OrderAfterSalesAfterSalesReturnShipmentsApi;
  public readonly events: OrderAfterSalesAfterSalesEventsApi;
...
export class OrderAfterSalesApi {
  private client: HttpClient;
  public readonly afterSales: OrderAfterSalesAfterSalesApi;
...
export function createOrderAfterSalesApi(client: HttpClient): OrderAfterSalesApi {
