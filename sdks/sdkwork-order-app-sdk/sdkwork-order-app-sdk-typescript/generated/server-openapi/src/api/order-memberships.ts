...
/** Create or reuse a membership purchase-intent order. */
  async create(body: MembershipOrderCreateCommand, params: OrderMembershipsMembershipsOrdersCreateParams, requestOptions?: ApiRequestOptions): Promise<MembershipOrderCreateResult> {
...
export function createOrderMembershipsApi(client: HttpClient): OrderMembershipsApi {
