...
/** Checkout sessions orders create. */
  async create(checkoutSessionId: string, params: OrderCheckoutCheckoutSessionsOrdersCreateParams, requestOptions?: ApiRequestOptions): Promise<CheckoutOrder> {
...
/** Checkout sessions quotes create. */
  async create(checkoutSessionId: string, params: OrderCheckoutCheckoutSessionsQuotesCreateParams, requestOptions?: ApiRequestOptions): Promise<CheckoutQuote> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
...
export class OrderCheckoutCheckoutSessionsApi {
  private client: HttpClient;
  public readonly quotes: OrderCheckoutCheckoutSessionsQuotesApi;
  public readonly orders: OrderCheckoutCheckoutSessionsOrdersApi;
...
/** Checkout sessions create. */
  async create(body: CreateCheckoutSessionRequest, params: OrderCheckoutCheckoutSessionsCreateParams, requestOptions?: ApiRequestOptions): Promise<CheckoutSession> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
...
export function createOrderCheckoutApi(client: HttpClient): OrderCheckoutApi {
