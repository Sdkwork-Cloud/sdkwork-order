...
export class AfterSalesEventsApi {
...
export interface AfterSalesReturnShipmentsListParams {
  status?: string;
  page?: number;
  pageSize?: number;
}
...
export interface AfterSalesRequestsListParams {
  status?: string;
  orderId?: string;
  page?: number;
  pageSize?: number;
...
export function createAfterSalesApi(client: HttpClient): AfterSalesApi {
  return new AfterSalesApi(client);
}
