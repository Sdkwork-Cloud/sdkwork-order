...
export class OrderPaymentsPaymentsOrderPaymentsApi {
...
/** Payments order Payments list. */
  async list(orderId: string, params?: OrderPaymentsPaymentsOrderPaymentsListParams, requestOptions?: ApiRequestOptions): Promise<SdkWorkPageData> {
...
export function createOrderPaymentsApi(client: HttpClient): OrderPaymentsApi {
  return new OrderPaymentsApi(client);
}
