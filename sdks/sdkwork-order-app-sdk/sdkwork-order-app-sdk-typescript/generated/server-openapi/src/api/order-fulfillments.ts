...
export class OrderFulfillmentsFulfillmentsApi {
...
export class OrderFulfillmentsApi {
  private client: HttpClient;
  public readonly fulfillments: OrderFulfillmentsFulfillmentsApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.fulfillments = new OrderFulfillmentsFulfillmentsApi(client);
  }

}

export function createOrderFulfillmentsApi(client: HttpClient): OrderFulfillmentsApi {
  return new OrderFulfillmentsApi(client);
}
