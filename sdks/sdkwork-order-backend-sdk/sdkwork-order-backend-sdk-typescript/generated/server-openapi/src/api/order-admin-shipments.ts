...
export class OrderAdminShipmentsShipmentsPackagesManagementApi {
...
/** List shipment packages */
  async list(shipmentId: string, params?: OrderAdminShipmentsShipmentsPackagesManagementListParams, requestOptions?: ApiRequestOptions): Promise<{ items: ShipmentPackageSummary[]; pageInfo: PageInfo; }> {
...
export class OrderAdminShipmentsShipmentsPackagesApi {
  private client: HttpClient;
  public readonly management: OrderAdminShipmentsShipmentsPackagesManagementApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.management = new OrderAdminShipmentsShipmentsPackagesManagementApi(client);
  }


/** Create shipment package */
  async create(shipmentId: string, body: CreateShipmentPackageRequest, params: OrderAdminShipmentsShipmentsPackagesCreateParams, requestOptions?: ApiRequestOptions): Promise<ShipmentPackageSummary> {
...
/** Update shipment package */
  async update(shipmentId: string, packageId: string, body: UpdateShipmentPackageRequest, params: OrderAdminShipmentsShipmentsPackagesUpdateParams, requestOptions?: ApiRequestOptions): Promise<ShipmentPackageSummary> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
...
export class OrderAdminShipmentsShipmentsApi {
  private client: HttpClient;
  public readonly packages: OrderAdminShipmentsShipmentsPackagesApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.packages = new OrderAdminShipmentsShipmentsPackagesApi(client);
  }


/** List shipments for operator review */
  async list(params?: OrderAdminShipmentsShipmentsListParams, requestOptions?: ApiRequestOptions): Promise<{ items: ShipmentSummary[]; pageInfo: PageInfo; }> {
    const query = buildQueryString([
      { name: 'status', value: params?.status, style: 'form', explode: true, allowReserved: false },
      { name: 'order_id', value: params?.orderId, style: 'form', explode: true, allowReserved: false },
      { name: 'fulfillment_id', value: params?.fulfillmentId, style: 'form', explode: true, allowReserved: false },
      { name: 'page', value: params?.page, style: 'form', explode: true, allowReserved: false },
      { name: 'page_size', value: params?.pageSize, style: 'form', explode: true, allowReserved: false },
    ]);
...
export class OrderAdminShipmentsApi {
  private client: HttpClient;
  public readonly shipments: OrderAdminShipmentsShipmentsApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.shipments = new OrderAdminShipmentsShipmentsApi(client);
  }

}

export function createOrderAdminShipmentsApi(client: HttpClient): OrderAdminShipmentsApi {
  return new OrderAdminShipmentsApi(client);
}
