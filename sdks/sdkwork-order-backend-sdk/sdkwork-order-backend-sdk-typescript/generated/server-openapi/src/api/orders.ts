...
export class OrdersAdminEventsApi {
...
export interface OrdersAdminCancellationsListParams {
  status?: string;
  page?: string;
  pageSize?: string;
}

export class OrdersAdminCancellationsApi {
  private client: HttpClient;
...
export class OrdersAdminApi {
  ...
  public readonly events: OrdersAdminEventsApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.cancellations = new OrdersAdminCancellationsApi(client);
    this.events = new OrdersAdminEventsApi(client);
  }
