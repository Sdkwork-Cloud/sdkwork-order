...
export class OrderAdminOrdersOrdersPaymentConfirmationsApi {
...
/** Reconcile provider payment and run the shared order settlement saga */
  async create(orderId: string, body: ConfirmOrderPaymentRequest, params: OrderAdminOrdersOrdersPaymentConfirmationsCreateParams, requestOptions?: ApiRequestOptions): Promise<Record<string, unknown>> {
...
export class OrderAdminOrdersOrdersAdminEventsApi {
  private client: HttpClient;
...
/** List order lifecycle events */
  async list(orderId: string, params?: OrderAdminOrdersOrdersAdminEventsListParams, requestOptions?: ApiRequestOptions): Promise<{ items: OrderEvent[]; pageInfo: PageInfo; }> {
...
export class OrderAdminOrdersOrdersAdminCancellationsApi {
  private client: HttpClient;
...
/** List order cancellation audit records */
  async list(params?: OrderAdminOrdersOrdersAdminCancellationsListParams, requestOptions?: ApiRequestOptions): Promise<{ items: OrderCancellation[]; pageInfo: PageInfo; }> {
    const query = buildQueryString([
...
/** List orders for operator review */
  async list(params?: OrderAdminOrdersOrdersAdminListParams, requestOptions?: ApiRequestOptions): Promise<{ items: OrderSummary[]; pageInfo: PageInfo; }> {
    const query = buildQueryString([
      { name: 'status', value: params?.status, style: 'form', explode: true, allowReserved: false },
...
/** Cancel an order from the admin surface */
  async cancel(orderId: string, params: OrderAdminOrdersOrdersAdminCancelParams, body?: CancelOrderRequest, requestOptions?: ApiRequestOptions): Promise<SdkWorkCommandData> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
...
/** Close an order from the admin surface */
  async close(orderId: string, params: OrderAdminOrdersOrdersAdminCloseParams, body?: CloseOrderRequest, requestOptions?: ApiRequestOptions): Promise<SdkWorkCommandData> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
...
export class OrderAdminOrdersOrdersApi {
  private client: HttpClient;
  public readonly admin: OrderAdminOrdersOrdersAdminApi;
  public readonly paymentConfirmations: OrderAdminOrdersOrdersPaymentConfirmationsApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.admin = new OrderAdminOrdersOrdersAdminApi(client);
    this.paymentConfirmations = new OrderAdminOrdersOrdersPaymentConfirmationsApi(client);
  }

}

export class OrderAdminOrdersApi {
  private client: HttpClient;
  public readonly orders: OrderAdminOrdersOrdersApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.orders = new OrderAdminOrdersOrdersApi(client);
  }

}

export function createOrderAdminOrdersApi(client: HttpClient): OrderAdminOrdersApi {
  return new OrderAdminOrdersApi(client);
}
