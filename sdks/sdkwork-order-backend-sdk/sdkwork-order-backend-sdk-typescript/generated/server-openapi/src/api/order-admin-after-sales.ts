...
export class OrderAdminAfterSalesAfterSalesReviewsApi {
...
/** Review after-sales request */
  async create(afterSalesRequestId: string, body: ReviewAfterSalesRequest, params: OrderAdminAfterSalesAfterSalesReviewsCreateParams, requestOptions?: ApiRequestOptions): Promise<AfterSalesRequestSummary> {
...
export class OrderAdminAfterSalesAfterSalesManagementApi {
  private client: HttpClient;
...
/** List after-sales requests for operator review */
  async list(params?: OrderAdminAfterSalesAfterSalesManagementListParams, requestOptions?: ApiRequestOptions): Promise<{ items: AfterSalesRequestSummary[]; pageInfo: PageInfo; }> {
...
export function createOrderAdminAfterSalesApi(client: HttpClient): OrderAdminAfterSalesApi {
  return new OrderAdminAfterSalesApi(client);
}
