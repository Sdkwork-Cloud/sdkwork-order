...
This README is the SDKWork module entrypoint for `sdkwork-commerce-order-service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
