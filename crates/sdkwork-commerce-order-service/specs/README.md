# SDKWork Commerce Order Component Specs

This directory is the local standards index for `sdkwork_commerce_order_service`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-order-service` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-order-service` |
| Domain | `commerce` |
| Capability | `order` |
| Languages | `rust` |
| Status | `stable` |
...
- `cargo test --manifest-path crates/sdkwork-commerce-order-service/Cargo.toml`
