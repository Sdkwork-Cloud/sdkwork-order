...
use crate::http_route_manifest::{backend_route_manifest, order_backend_api_public_path_prefixes};
...
pub fn wrap_router_with_web_framework(
    ...
    route_manifest
        .validate_public_path_prefixes(&order_backend_api_public_path_prefixes())
        .expect("order backend-api public prefixes must not cover protected manifest routes");
