# SDKWork Order PC React Component Specs

This directory is the local standards index for `@sdkwork/order-pc-order`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/order-pc-order` |
| Type | `react-package` |
| Root | `sdkwork-order/apps/sdkwork-order-pc/packages/sdkwork-order-pc-order` |
| Domain | `commerce` |
| Capability | `order` |
